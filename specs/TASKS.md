...
- [ ] **B2** LinkedIn (endpoint guest, com mitigação de rate-limit e segunda passada no fim do ciclo).
- [ ] **B3** SIARE/UFSC e FEPESE (avaliar login/PDF; decidir automatizar vs manual).
